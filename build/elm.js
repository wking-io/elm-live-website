...
var author$project$FileSystem$None = {$: 'None'};
var author$project$FileSystem$File$Content$htmlMain = 'html here';
var author$project$FileSystem$Folder$Closed = {$: 'Closed'};
var author$project$FileSystem$Folder$map3 = F2(
	function (f, vis) {
		return f(vis);
	});
var author$project$FileSystem$Folder$mapClosed = function (f) {
	return A2(author$project$FileSystem$Folder$map3, f, author$project$FileSystem$Folder$Closed);
};
var author$project$FileSystem$Node$Folder = F2(
	function (a, b) {
		return {$: 'Folder', a: a, b: b};
	});
var author$project$FileSystem$Node$makeFolder = F3(
	function (visibility, name, children) {
		return A2(
			author$project$FileSystem$Node$Folder,
			{name: name, visibility: visibility},
			children);
	});
var author$project$FileSystem$Node$makeClosedFolder = author$project$FileSystem$Folder$mapClosed(author$project$FileSystem$Node$makeFolder);
var author$project$FileSystem$File$Extension$Html = {$: 'Html'};
var author$project$FileSystem$File$Extension$toString = function (extension) {
	switch (extension.$) {
		case 'Js':
			return 'js';
		case 'Json':
...
var author$project$FileSystem$File$Id$Id = function (a) {
	return {$: 'Id', a: a};
};
...
var author$project$FileSystem$File$Id$generate = F3(
	function (parent, filename, filetype) {
		return author$project$FileSystem$File$Id$Id(
			_Utils_ap(
				parent,
				_Utils_ap(
					filename,
					author$project$FileSystem$File$Extension$toString(filetype))));
	});
var author$project$FileSystem$Node$File = function (a) {
	return {$: 'File', a: a};
};
var author$project$FileSystem$Node$makeFile = F4(
	function (extension, parent, name, contents) {
		return author$project$FileSystem$Node$File(
			{
				contents: contents,
				extension: extension,
				id: A3(author$project$FileSystem$File$Id$generate, parent, name, extension),
				name: name
			});
	});
var author$project$FileSystem$Node$makeHtmlFile = author$project$FileSystem$Node$makeFile(author$project$FileSystem$File$Extension$Html);
var author$project$FileSystem$File$Extension$Js = {$: 'Js'};
var author$project$FileSystem$Node$makeJsFile = author$project$FileSystem$Node$makeFile(author$project$FileSystem$File$Extension$Js);
var author$project$FileSystem$outputNode = F2(
	function (parent, _n0) {
		var flags = _n0.b;
		switch (flags.$) {
			case 'Default':
				return _List_fromArray(
					[
						A3(author$project$FileSystem$Node$makeHtmlFile, parent, 'index', 'Compiled Elm Here')
					]);
			case 'Build':
				return _List_fromArray(
					[
						A3(author$project$FileSystem$Node$makeJsFile, parent, 'elm', 'Compiled Elm Here'),
						A3(author$project$FileSystem$Node$makeHtmlFile, parent, 'index', author$project$FileSystem$File$Content$htmlMain)
					]);
			case 'CustomBuild':
				return _List_fromArray(
					[
						A3(author$project$FileSystem$Node$makeHtmlFile, parent, 'custom', author$project$FileSystem$File$Content$htmlMain),
						A3(author$project$FileSystem$Node$makeJsFile, parent, 'elm', 'Compiled Elm Here')
					]);
			case 'BuildDir':
				return _List_fromArray(
					[
						A2(
						author$project$FileSystem$Node$makeClosedFolder,
						'build',
						_List_fromArray(
							[
								A3(author$project$FileSystem$Node$makeJsFile, parent, 'elm', 'Compiled Elm Here'),
...
var author$project$FileSystem$File$Content$elmJson = 'elm json';
var author$project$FileSystem$File$Content$elmMain = 'elm stuff';
var author$project$FileSystem$File$Content$packageJson = 'package here';
var author$project$FileSystem$File$Content$styleCss = 'styles here';
var author$project$FileSystem$File$Extension$Css = {$: 'Css'};
var author$project$FileSystem$Node$makeCssFile = author$project$FileSystem$Node$makeFile(author$project$FileSystem$File$Extension$Css);
var author$project$FileSystem$File$Extension$Elm = {$: 'Elm'};
var author$project$FileSystem$Node$makeElmFile = author$project$FileSystem$Node$makeFile(author$project$FileSystem$File$Extension$Elm);
var author$project$FileSystem$File$Extension$Json = {$: 'Json'};
var author$project$FileSystem$Node$makeJsonFile = author$project$FileSystem$Node$makeFile(author$project$FileSystem$File$Extension$Json);
var author$project$FileSystem$generate = F2(
		...
		if (options.$ === 'Raw') {
			...
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3(author$project$FileSystem$Node$makeElmFile, parent, 'Main', author$project$FileSystem$File$Content$elmMain)
						])),
					A3(author$project$FileSystem$Node$makeJsonFile, parent, 'elm', author$project$FileSystem$File$Content$elmJson),
					A3(author$project$FileSystem$Node$makeCssFile, parent, 'style', author$project$FileSystem$File$Content$styleCss),
					A3(author$project$FileSystem$Node$makeJsonFile, parent, 'package', author$project$FileSystem$File$Content$packageJson)
				]);
		} else {
			var flags = options.a;
			return _Utils_ap(
				A2(author$project$FileSystem$outputNode, parent, flags),
				_List_fromArray(
					[
						A2(
						author$project$FileSystem$Node$makeClosedFolder,
...
var author$project$FileSystem$Folder$Open = {$: 'Open'};
var author$project$FileSystem$Folder$mapOpen = function (f) {
	return A2(author$project$FileSystem$Folder$map3, f, author$project$FileSystem$Folder$Open);
};
var author$project$FileSystem$Node$makeOpenFolder = author$project$FileSystem$Folder$mapOpen(author$project$FileSystem$Node$makeFolder);
var author$project$FileSystem$Node$sort = function (node) {
	if (node.$ === 'Folder') {
...
var author$project$FileSystem$fromOptions = function (options) {
	return A2(
		author$project$FileSystem$FileSystem,
		author$project$FileSystem$None,
		A2(
			author$project$FileSystem$Node$makeOpenFolder,
			'my-project',
			A2(
...
var author$project$Main$ChangeFocus = function (a) {
	return {$: 'ChangeFocus', a: a};
};
var author$project$Main$Compile = {$: 'Compile'};
var author$project$FileSystem$File$Extension$toExtension = function (ext) {
	return '.' + author$project$FileSystem$File$Extension$toString(ext);
};
var author$project$FileSystem$File$Id$toString = function (_n0) {
	var id = _n0.a;
	return id;
};
...
var author$project$View$File$viewItem = F3(
	function (focus, _n0, msg) {
		var id = _n0.id;
		var name = _n0.name;
		var extension = _n0.extension;
		return A2(
			elm$html$Html$li,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							author$project$FileSystem$File$Id$toString(id) + '-tab'),
							A2(elm$html$Html$Attributes$attribute, 'role', 'tab'),
							A2(
							elm$html$Html$Attributes$attribute,
							'aria-controls',
							author$project$FileSystem$File$Id$toString(id)),
					...
					_List_fromArray(
						[
							...
							_Utils_ap(
								name,
								author$project$FileSystem$File$Extension$toExtension(extension)))
						]))
				]));
	});
...
var author$project$View$FileSystem$filesHelp = F3(
	function (focus, fileMsg, node) {
		if (node.$ === 'Folder') {
			var name = node.a.name;
			var visibility = node.a.visibility;
			var children = node.b;
			if (visibility.$ === 'Open') {
				return _List_fromArray(
					[
						...
						_Utils_ap(
							...
							A2(
								...
								A2(author$project$View$FileSystem$filesHelp, focus, fileMsg),
								children)))
					]);
			} else {
				return _List_fromArray(
			...
			return _List_fromArray(
				[
					A3(author$project$View$File$viewItem, focus, data, fileMsg)
				]);
		}
	});
var author$project$View$FileSystem$files = F2(
	function (_n0, fileMsg) {
		var focus = _n0.a;
		var node = _n0.b;
		return A2(
			elm$html$Html$div,
			_List_Nil,
			A3(author$project$View$FileSystem$filesHelp, focus, fileMsg, node));
	});
var elm$html$Html$button = _VirtualDom_node('button');
var author$project$Main$view = function (_n0) {
	var filesystem = _n0.filesystem;
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				A2(author$project$View$FileSystem$files, filesystem, author$project$Main$ChangeFocus),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$Compile)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Compile')
					]))
			]));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"Compile":[],"ChangeFocus":["FileSystem.File.Id.Id"],"ToggleFolder":[]}},"FileSystem.File.Id.Id":{"args":[],"tags":{"Id":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));